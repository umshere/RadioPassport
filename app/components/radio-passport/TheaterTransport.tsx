...
export function TheaterTransport() {
  ...
  const copy = theaterTransportCopy({
    isPlaying,
    kept,
    stamped,
    secondsLeft,
  ...
  return (
    <div className="ew-theater-transport" role="group" aria-label="Room controls">
      <span className="ew-theater-cell">
        <button
          type="button"
        ...
        <span className="ew-theater-clabel" aria-hidden="true">{copy.back}</span>
      </span>
      <span className={`ew-theater-cell${kept ? " is-on" : ""}`}>
        <button
          type="button"
        ...
        <span className="ew-theater-clabel" aria-hidden="true">{copy.keep}</span>
      </span>
      <span className="ew-theater-cell">
        <button
          type="button"
        ...
        <span className="ew-theater-clabel" aria-hidden="true">{copy.play}</span>
      </span>
      <span className="ew-theater-cell">
        <button
          type="button"
        ...
        <span className="ew-theater-clabel" aria-hidden="true">{copy.next}</span>
      </span>
      <span className={`ew-theater-cell${stamped ? " is-on" : ""}`}>
        <button
          type="button"
          ...
          aria-label={`Passport — ${copy.passportHint}`}
          title={copy.passportHint}
        >
          <span>
            {stamped ? (
        ...
        <span className="ew-theater-clabel" aria-hidden="true">{copy.passport}</span>
      </span>
    </div>
  );
}
